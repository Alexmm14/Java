...
public class Alumno {
    ...
    public static void main(String[] args) {
       ...
       Alumno a2 = new  Alumno();
        ...
        JOptionPane.showMessageDialog(null, " Numero de cuenta: " + a1.numeCuenta + "\n" + "Nombre: " + a1.nombre + "\n" + "Fecha nacimiento: " + a1.fecha + "\n" + "edad: " + a1.edad, "Valores alumno 2", JOptionPane.INFORMATION_MESSAGE);
    ...
    @Override
        ...
        return getClass().getName() + "@" + Integer.toHexString(hashCode()) + "Numero Cuenta: " + getNumeCuenta() + "\n " + "Nombre: " + getNombre() + "\n " + "Fecha: " + getFecha() + "\n "+ "Edad: " + getEdad();
